...
class Palette(BaseModel):
    ...
    def save_current_results(self):
        ret_path = []
        ret_result = []
        print('save_current_results self.gt_image.min():', self.gt_image.min())
        print('save_current_results self.cond_image.min():', self.cond_image.min())
        print('save_current_results self.visuals.min():', self.visuals.min())
        print('save_current_results self.gt_image.max():', self.gt_image.max())
        print('save_current_results self.cond_image.max():', self.cond_image.max())
        print('save_current_results self.visuals.max():', self.visuals.max())
